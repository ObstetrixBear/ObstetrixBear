...
I'm currently looking into [Rust](https://en.wikipedia.org/wiki/Go_(programming_language)) and [Forth](https://en.wikipedia.org/wiki/Go_(programming_language)). [Racket](https://en.wikipedia.org/wiki/Racket_(programming_language)), [Golang](https://en.wikipedia.org/wiki/Go_(programming_language)), Odin and [Smalltalk](https://en.wikipedia.org/wiki/Smalltalk_(programming_language)) also interest me for different reasons. Plus, of course, the need to master [Angular](https://en.wikipedia.org/wiki/Angular_(web_framework)). There's a lot to do. 
